...
import Animated, { BounceIn, interpolate, useAnimatedStyle, useSharedValue } from 'react-native-reanimated';
...
const CategoryList = () => {
    ...
    const Data = [
        { id: 3, name: "Mathematics", count: 10, image_url: "https://cdn3d.iconscout.com/3d/premium/thumb/maths-class-5748771-4817936.png" },
        ...
        { id: 7, name: "Programming", count: 10, image_url: "https://img.icons8.com/3d-fluency/512/laptop-coding.png" }
    ]
            ...
            <TouchableOpacity onPress={()=>navigation.navigate("DetailsScreen",{item:item})}>
                <Animated.View
                    ...
                    <View style={styles.description}>
                        ...
                        <Text style={[styles.count, { color: colors.mutedText }]}>{item?.count} Questions</Text>
                    </View>
                </Animated.View>
            </TouchableOpacity>
        ...
        <View style={styles.container}>
            ...
            <Animated.View style={listStyle}>
                <View style={styles.header}>
                    <Text style={[styles.title, { color: colors.text }]}>Let's Play</Text>
                </View>
                <AnimatedFlatList
                    data={Data}
                    numColumns={2}
